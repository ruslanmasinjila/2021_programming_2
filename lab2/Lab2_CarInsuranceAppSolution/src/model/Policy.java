...
public class Policy implements Serializable {
    ...
    /**
     * This method breaks the build, but it is in the amendment document ??
     */
//    public void removeDriver1(Calendar dateOfBirth) {
//        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
//        String dateString = formatter.format(dateOfBirth.getTime());
//        Predicate dateOfBirthPredicate = d-> formatter.format(d.getDateOfBirth().getTime()).equals( dateString);
//        this.namedDrivers.removeIf(dateOfBirthPredicate); 
//}
