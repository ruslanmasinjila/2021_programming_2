...
public class CustomerProjectsController {
    ...
    public CustomerProjectsController() {
        ...
        if (c == 'Y' || c == 'y') {
            String fileName = inputHelper.readString("Enter filename with its extension (example file1.txt or file2.dat)");               
    ...
    public void run() {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 'F':
                    InputHelper inputHelper = new InputHelper();
                    String fileName = inputHelper.readString("Enter filename with extension (example file1.txt or file2.dat)");                
